...
namespace ConsoleApp8
{
    internal class Program
    {
        ...
        {
            int y = 0;
            Console.WriteLine("Привет данная программаа расскажет тебе о машине. Выбери какая характеристика тебе нужна:\n 1 - Изготовитель,\n 2 - Марка,\n 3 - Год выпуска,\n 4 - Количество колёс,\n 5 - Количество движков,\n 6 - Наличие битости,\n 7 - Наличие перекрашивания,\n 8 - Гарантия,\n 9 - Количество хозяе,\n 10 - Бак,\n 11 - Расход,\n 12 - Максималка,\n 13 - Разгон до 100,\n 14 - Чехлы на сидениях,\n 15 - Цвет,\n 16  - Диски,\n 17 - Зимняя резина,\n 18 - Чехол на руле,\n 19 - Комплектация,\n 20 - Машина класса.");
            string[] massive = { "Tayota", "Mark II", "2000-2004", "4 колеса", "1 движок", "Не битая", "Не крашеная", "10 лет", "1 хозяин", "150 литров", "15 литров", "200 км/ч", "20 секунд", "nety", "beliy", "krasivo", "nety", "есть", "123", "SSS rank" };
